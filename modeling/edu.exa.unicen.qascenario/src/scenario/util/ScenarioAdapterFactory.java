...
public class ScenarioAdapterFactory extends AdapterFactoryImpl {
   ...
   */
	protected ScenarioSwitch<Adapter> modelSwitch =
      ...
      @Override
      public Adapter caseGeneralScenario(GeneralScenario object) {
        return createGeneralScenarioAdapter();
      }
      @Override
      public Adapter caseSpecificScenario(SpecificScenario object) {
        return createSpecificScenarioAdapter();
      }
      @Override
   ...
   */
	...
	/**
   * Creates a new adapter for an object of class '{@link scenario.GeneralScenario <em>General Scenario</em>}'.
   * <!-- begin-user-doc -->
   ...
   */
	...
	/**
   * Creates a new adapter for an object of class '{@link scenario.SpecificScenario <em>Specific Scenario</em>}'.
   * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
   ...
   */
	...
	/**
   * Creates a new adapter for an object of class '{@link scenario.Phrase <em>Phrase</em>}'.
   * <!-- begin-user-doc -->
   * This default implementation returns null so that we can easily ignore cases;
   * it's useful to ignore a case when inheritance will catch all the cases anyway.
   * <!-- end-user-doc -->
